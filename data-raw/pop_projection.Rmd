...
# Predict future population of Ontario

# Use of the demography package in R for stochastic population forecasting with coherent components. Based on the papers by Hyndman and Booth (IJF 2008), Hyndman, Booth and Yasmeen (Demography 2013), and the tutorial linked here: https://robjhyndman.com/hyndsight/coherent-population-forecasting/
...
Population data for Ontario is loaded, which contains annual population estimates by age and sex for the years 1971 to 2020 for ages 0-100 and over. "The population growth, which is used to calculate population estimates, is comprised of the natural growth (Tables 17100006 and 17100016), international migration (Table 17100014) and interprovincial migration (Table 17100015)." - StatCan.

```{r }
popON <- read.csv("../../Data/Demography data/pop_ON_Oct2021.csv")
...
```{r }
fert <- read.csv("../../Data/Demography data/fert_ON_Oct2021.csv") #StatCan dataset
...
```{r }
mort <- read.csv("../../Data/Demography data/mort_ON_Oct2021_new.csv")

colnames(mort)<- c("Sex","Age",1971:2020)
#colnames(mort)<- c("Sex","Age",1972:2021) #as the years are written as 1971/1972 to 2020/2021 this should be specified as 1972-2021?
